...
%       "-l,--lower,--xmin", x_min, "x min value");
%     app.add_option(
%       "-u,--upper,--xmax", x_max, "x max value");
%     app.add_flag(
%       "-v,--show-func-values", show_function_values);
%     app.add_flag(
%       "-s,--sequential", run_sequentially);
%     app.add_flag(
%       "-c,--cpu-only", run_cpuonly);
%     app.add_option(
%       "-x,--x-format-precision", x_precision, 
%       "decimal precision for x values")->
%       check(CLI::PositiveNumber.description(" >= 1"));
%     app.add_option(
%       "-y,--y-format-precision", y_precision, 
%       "decimal precision for y (function) values")->
